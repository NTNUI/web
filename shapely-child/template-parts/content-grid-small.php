...
?>
	<article id="post-<?php the_ID(); ?>" <?php post_class( 'post-content post-grid-small col-md-3' ); ?> >
		<header class="entry-header nolist">
			<?php
			$category      = get_the_category();
			$show_category = false; /*orginal er true: Peder 28.04.2018-> Dette tok vekk kategori visningen*/
			if ( is_category() ) {
